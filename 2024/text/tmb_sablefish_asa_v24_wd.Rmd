---
title: "Northern Southeast Inside Subdistrict Sablefish (*Anoplopoma fimbria*) Management Plan and Stock Assessment for 2024"
...
catch<-read_csv("C:/Users/pjjoy/Documents/Groundfish Biometrics/Sablefish/seak_sablefish/2024/output/harvest_1985_202333.csv")
...
decr<-read_csv(paste0("C:/Users/pjjoy/Documents/Groundfish Biometrics/Sablefish/seak_sablefish/legacy_data/decrements_2023.csv"))

#MR<-read_csv(r_output_dir,paste0("tag_summary_report_2022.csv"))
MR<-read_csv("C:/Users/pjjoy/Documents/Groundfish Biometrics/Sablefish/seak_sablefish/2024/output/tag_summary_report_2023.csv")

model_comp<-read_csv("C:/Users/pjjoy/Documents/Groundfish Biometrics/Sablefish/seak_sablefish/2024/output/tmb/scaa_brps_2024_MODEL_COMPARISON_for_pub.csv")
...
aho[nrow(aho),"Annual_harvest_objective"] <- 1300000
aho[nrow(aho),'Equal_quota_share'] <- 17000
...
kable(tab1, booktabs = TRUE, longtable = TRUE,  #format = "latex", 
      ...
      caption = "Annual harvest objective (round lb), equal quota share (round lb), reported harvest (round lb), exvessel value, numberof permits, and effort (dats) for the directed commercial Northern Southeast Inside (NSEI) Subdistrict sablefish fishery, 1985-2022.") %>% kable_styling(full_width = F)
...
kable(decr, booktabs = TRUE, longtable = TRUE, #format = "latex", 
      ...
      caption = paste0("Decrement types and amounts, ", YEAR-5,"-",YEAR+1,".  Estimated catch in round pounds of sablefish.")) %>% kable_styling(full_width = F) %>%
...
kable(MR, booktabs = TRUE, longtable = TRUE, format.args = list(big.mark = ","),#format = "latex", 
      ...
      caption = paste0("A summary of data inputs to the mark-recapture models, including total individuals tagged (*K*), the total number of tags remaining once size selectivity is accounted for ($K_0$), tags not available to the longline survey or fishery (captured in ther fisheries or outside Chatham, $D_0$), recaptured individuals in the lpongline survey and fishery ($k_{srv}$ and $k_{fsh}$), number of sampled individuals in the longline survey and fishery ($n_{srv}$ and $n_{fsh}$), tags not available to the fishery (captured outside Chatham or in other fisheries during the survey, $D_{srv}$, and tags recaptred in other fisheries or outside Chatham during the fishery ($D_{fsh}$) for years with a tagging survey, 2005-",YEAR+1,".")) %>% kable_styling(full_width = F) #%>% column_spec(MR,2:ncol(MR),format.args = list(big.mark = ","))
...
```{r nseimap, out.width = "50%", fig.cap= paste0("Northern Southeast Inside (NSEI) and Southern Southeast Inside (SSEI) Subdistricts including restricted waters of Glacier Bay National Park and Preserve and Annette Islands Reserve.")}
...
#knitr::include_graphics("C:/Users/pjjoy/Documents/Groundfish Biometrics/Sablefish/seak_sablefish/2023/figures/tmb/sable_data_all.png")
...
#knitr::include_graphics(paste0(figures_dir,"/sable_data_yprmodel_",YEAR,".png"))
```
<br><br><br>
