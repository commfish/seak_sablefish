...
VER <- "v23_sexyage_fixfshsel"
slx_pars <- read_csv(paste0(YEAR+1,"/data/tmb_inputs/slx_inits_v23_sexyage_fixfshsel_2024.csv"))
...
VER<-"v23_sexyage_fixfshsel" #"boot_gam22"  #"base_22rb" #"base" #"boot_gam" #"base_gam" #"base_nom" 
...
parameters <- build_parameters_24(rec_devs_inits = rec_devs_inits, Fdevs_inits = Fdevs_inits)
