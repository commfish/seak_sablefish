...
tag_sum[c(2,4)] <- lapply(tag_sum[,c(2,4)], prettyNum, trim=TRUE, big.mark=",")
...
`r tbl('tag_sum', caption = paste0('A summary of data inputs to the mark-recapture models, including marked individuals ($K_0$), recaptured individuals ($k$), sampled individuals ($n$), tags recaptured before the longline survey ($D_0$), and during the survey or the fishery ($D$) for years with a mark survey from 2005 to ', YEAR ,'. '))`
