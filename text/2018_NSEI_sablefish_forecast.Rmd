...
2.  Discard mortality of sablefish was incorporated into the calculations of exploitable abundance and *ABC*. In past years instead discard mortality of small, unmarketable fish was not accounted for. However, the large influx of small fish in the population makes this source of mortality unavoidable, and therefore it needs to be accounted for. The probability of a fish being discarded was modeled as a function of weight and informed by processor grade definitions and prices.  
...
`r fig('catch', caption = paste0('Fishery harvest in Chatham Strait from 1985 to ', YEAR, '. The vertical dashed line marks the transition of the fishery from limited entry to equal quota share in 1997.'))`
