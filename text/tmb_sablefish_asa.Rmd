...
2.  Fishery CPUE, the two survey CPUE indices, and the mark-recapture abundance index were modeled using log-normal likelihoods, where $\sigma_I$ was assumed to be 0.20 for the survey and fishery CPUEs and annual posterior standard deviations were used for the mark-recapture abundance index:
