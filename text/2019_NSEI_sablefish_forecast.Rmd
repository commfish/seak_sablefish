...
- The `r YEAR+1` recommended Allowable Biological Catch ($ABC$) for Northern Southeast Inside Waters (NSEI - Chatham Strait) at a fully-selected fishing mortality of $F_{50\%}$ = `r ABC` round lb (`r tbl('full_summary', display = "cite")`). This is a `r diff` lb increase (`r perc_change`%) from the `r YEAR` $ABC$ of `r ABC_ly` round lb.
...
The $ABC$ for `r YEAR+1` was estimated to be `r ABC` round lb, and the discarded portion of the catch was estimated to be `r discards` round lb (`r tbl('full_summary', display = "cite")`). 
